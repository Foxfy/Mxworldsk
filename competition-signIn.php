...
<head>
    ...
    <title>Competition | Sign In</title>
    ...
    <div class="h-screen">
        ...
        ?>
            <div class="form-center">
                <form action="Controllers/checkUserController.php" method="post" class="form-space">
                    <div class="row">
                        <h1>Sign In</h1>
                        <div class="col">
                            ...
                            <div class="d-flex gap-3 mt-5">
                                <button type="submit" class="btn btn-competition w-100">Sign In</button>
